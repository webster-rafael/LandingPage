    ...
    var data = {
        "resource": {
            ...
            "macros": [{
                ...
                "function": "__c",
                "vtp_value": "1027301081512920"
            }, {
                "function": "__cvt_63830170_6",
            ...
            "tags": [{
                ...
                "vtp_conversionLabel": "zsRfCMHsz5gYEMfzwIEp",
                "vtp_rdp": false,
                "vtp_url": ["macro", 4],
                ...
                "vtp_enableShippingData": false,
                "vtp_conversionId": ["macro", 3],
                "vtp_conversionLabel": "e3IGCMTsz5gYEMfzwIEp",
                "vtp_rdp": false,
                "vtp_url": ["macro", 4],
                "vtp_enableProductReportingCheckbox": true,
                "vtp_enableNewCustomerReportingCheckbox": true,
            ...
            "predicates": [{
                ...
                "function": "_cn",
                "arg0": ["macro", 2],
                "arg1": "felipesotero.com\/agradecimento\/"
            }, {
                "function": "_cn",
                "arg0": ["macro", 5],
                "arg1": "joinchat"
        ...
        ,
        "sandboxed_scripts": [
            "__cvt_63830170_5", "__cvt_63830170_6"
    ...
    */
    ...
    var Td = function(a, b, c, d) {
        ...
        Wd = function(a, b) {
            ...
            if (a instanceof qb || a instanceof pb || a instanceof ed) c = a.get(b);
            else if ("string" === typeof a) "length" === b ? c = a.length : ob(b) && (c = a[b]);
    ...
    var bg = $f,
        ...
        dg = ag.Im;
    var og = /^[a-z$_][\w$]*$/i,
        pg = /^(?:[a-z_$][a-z_$0-9]*\.)*[a-z_$][a-z_$0-9]*(?:\.\*)?$/i,
        qg = function(a, b) {
            for (var c = 0; c < b.length; c++) {
                var d = a,
                    e = b[c];
                if (!pg.exec(e)) throw Error("Invalid key wildcard");
                var f = e.indexOf(".*"),
                    g = -1 !== f && f === e.length - 2,
        ...
        K = function(a, b, c) {
            for (var d = 0; d < b.length; d++) {
                ...
                if (null == m) {
                    ...
                    var n = typeof m;
                    m instanceof ed ? n = "Fn" : m instanceof pb ? n = "List" : m instanceof qb ? n = "PixieMap" : m instanceof ld && (n =
                        "OpaqueValue");
        ...
        Rg = function(a, b) {
            ...
            for (d in b)
                if (b.hasOwnProperty(d)) {
                    var e = b[d];
                    Ba(e) ? c.set(d, Qg(a + "_" + d, e)) : kb(e) ? c.set(d, Rg(a + "_" + d,
    ...
    var N = {
        ...
        Yh = {},
        Zh = Object.freeze((Yh[N.g.da] = 1, Yh[N.g.Qe] = 1, Yh[N.g.pd] = 1, Yh[N.g.qb] = 1, Yh[N.g.Z] = 1, Yh[N.g.Sa] = 1, Yh[N.g.Ha] = 1, Yh[N.g.Ta] = 1, Yh[N.g.kc] = 1, Yh[N.g.Hc] = 1, Yh[N.g.La] =
    ...
    var $h = {},
        ...
        ki = Object.freeze((ji[N.g.da] = 1, ji[N.g.pd] = 1, ji[N.g.Ga] = 1, ji[N.g.Gb] = 1, ji[N.g.Re] = 1, ji[N.g.rd] = 1, ji[N.g.sd] = 1, ji[N.g.ud] = 1, ji[N.g.Z] = 1, ji[N.g.vd] = 1, ji[N.g.Ka] = 1, ji[N.g.Ca] = 1, ji[N.g.Sa] = 1, ji[N.g.Ha] = 1, ji[N.g.Ta] = 1, ji[N.g.La] = 1, ji[N.g.qa] = 1, ji[N.g.wd] = 1, ji[N.g.aa] = 1, ji[N.g.ki] = 1, ji[N.g.zd] = 1, ji[N.g.Ad] = 1, ji[N.g.We] = 1, ji[N.g.Dd] = 1, ji[N.g.Jb] = 1, ji[N.g.vb] = 1, ji[N.g.Ia] = 1, ji[N.g.Oc] = 1, ji[N.g.ra] =
            1, ji[N.g.Ea] = 1, ji[N.g.sg] = 1, ji[N.g.ug] = 1, ji[N.g.vg] = 1, ji[N.g.wg] = 1, ji[N.g.Lb] = 1, ji[N.g.Ma] = 1, ji[N.g.Mb] = 1, ji[N.g.Ld] = 1, ji[N.g.Tc] = 1, ji[N.g.sa] = 1, ji[N.g.Nb] = 1, ji[N.g.Ob] = 1, ji[N.g.Ab] = 1, ji[N.g.wa] = 1, ji[N.g.za] = 1, ji[N.g.fa] = 1, ji)),
        li = {},
    ...
    ni.ee = Number("0") || 0;
    ni.ia = "dataLayer";
    ni.Rj = "ChEI8KPbpwYQ8KSn4f20s4nvARIkAMazRqsQlRnC6VVDQY1Z9EBpk/61jAKT/H1Nz0i8kZ5r6G+zGgJOuA\x3d\x3d";
    var qi = {
            __cl: 1,
            __ecl: 1,
            __ehl: 1,
    ...
    a: {
        for (var fj = void 0, gj = void 0, hj = 0; fj === gj;)
            if (fj = Math.floor(2 * Math.random()), gj = Math.floor(2 * Math.random()), hj++, 20 < hj) break a;fj ? P[75] = !0 : P[76] = !0
    }
    ...
    var jj;
    try {
        jj = JSON.parse(wb("eyIwIjoiQlIiLCIxIjoiQlItTVMiLCIyIjpmYWxzZSwiMyI6Imdvb2dsZS5jb20uYnIiLCI0IjoiIiwiNSI6ZmFsc2UsIjYiOmZhbHNlLCI3IjoiYWRfc3RvcmFnZXxhbmFseXRpY3Nfc3RvcmFnZXxhZF91c2VyX2RhdGF8YWRfcGVyc29uYWxpemF0aW9uIn0"))
    } catch (a) {
        M(123), ij(2), jj = {}
    }
    var kj = function() {
        ...
        if (Dj(p, n, e, f)) {
            ...
            q && z.setTimeout(function() {
                if (k[b] === r && r.quiet) {
                    ...
                    var t = [b];
                    if (nf(4))
                        for (var u in wj) wj.hasOwnProperty(u) && wj[u] === b && t.push(u);
                    for (var v =
                            0; v < t.length; v++) Ej(a, t[v]);
                    a.notifyListeners();
                    yb("TAGGING", 2)
                }
            }, g)
    ...
    aa.update = function(a, b) {
        ...
        if (void 0 != b) {
            ...
            var f = this.getConsentState(a),
                g = [a];
            if (nf(4))
                for (var k in wj) wj.hasOwnProperty(k) && wj[k] === a && g.push(k);
            if (e.quiet) {
                e.quiet = !1;
        ...
        Wk = function(a, b, c) {
            ...
            try {
                ...
                if ("array" === d) {
                    ...
                    for (var e = 0; e < b.length; e++)
                        if (Wk(a, b[e], c[e])) return !0
                } else {
                    for (var f in c)
                        if (!b.hasOwnProperty(f)) return !0;
                    for (var g in b)
                        if (!c.hasOwnProperty(g) || Wk(a, b[g], c[g])) return !0
                }
            } catch (k) {
                M(72)
            }
    ...
    Xb("Edge");
    !Xb("Gecko") || -1 != Tb().toLowerCase().indexOf("webkit") && !Xb("Edge") || Xb("Trident") || Xb("MSIE") || Xb("Edge"); - 1 != Tb().toLowerCase().indexOf("webkit") && !Xb("Edge") && Xb("Mobile");
    pl() || Xb("Macintosh");
    pl() || Xb("Windows");
    ...
    var tl = function(a, b, c, d) {
        ...
        wl = /[?&]($|#)/,
        xl = function(a, b, c) {
            for (var d, e = a.search(ul), f = 0, g, k = []; 0 <= (g = tl(a, f, b, e));) k.push(a.substring(f,
    ...
    var Nl = function(a, b, c) {
            ...
            else m = 1 === k ? a.purpose && a.vendor ? Ml(a.purpose.legitimateInterests,
                b) && Ml(a.vendor.legitimateInterests, void 0 === d ? "755" : d) : !0 : !0;
            return m
        },
        Ml = function(a, b) {
            return !(!a || !a[b])
            ...
            if ((Vl() || Q(85)) && !a.active && Kl(b)) {
                ...
                try {
                    b.addEventListener(function(c) {
                        if (0 !== c.internalErrorState) Xl(a), Yl(a);
                        else {
    ...
    var mm = function(a) {
        ...
        nm = function() {
            ...
            var a = Aj(),
                ...
                e = [];
            if (b && d)
                for (var f in xj) xj.hasOwnProperty(f) && xj[f].enabled && c.hasOwnProperty(f) && c[f].enabled && e.push(f);
            else {
                var g = b ? xj : c,
                    k;
    ...
    var vn = /:[0-9]+$/,
        ...
        An = function(a, b, c, d, e) {
            ...
            "port" === b ? a.port =
                String(Number(a.hostname ? a.port : z.location.port) || ("http" === a.protocol ? 80 : "https" === a.protocol ? 443 : "")) : "host" === b && (a.hostname = (a.hostname || z.location.hostname).replace(vn, "").toLowerCase());
            return zn(a, b, c, d, e)
        },
        zn = function(a, b, c, d, e) {
            var f, g = yn(a.protocol);
            b && (b = String(b).toLowerCase());
            switch (b) {
                    ...
                    if (void 0 !== yo[f]) {
                        ...
                        if (k) {
                            ...
                            b: {
                                var p = m;
                                if (um(z))
                                    for (var q = xm(g, C.cookie, void 0, "ad_storage"), r = 0; r < q.length; ++r)
                                        if (Mo(q[r]) > p) {
                                            n = !0;
                                            break b
                                        }
    ...
    var hp = function(a, b, c) {
            ...
            z[a.functionName] = d;
            if (a.rf)
                for (var e = 0; e < a.rf.length; e++) z[a.rf[e]] = z[a.rf[e]] || gp();
    ...
    var Ep = function(a, b, c) {
        ...
        Pp = function(a) {
            ...
            Ip(function() {
                if (Q(82) && Q(91) || S(N.g.I)) {
                    ...
                    var v =
                        S(N.g.I) ? 'https://adservice.google.com/pagead/regclk' : "https://adservice.googlesyndication.com/pagead/regclk";
                    if (0 < n.length)
                        for (var w = 0; w < n.length; w++) {
                            var x = n[w],
                                y = x.X,
        ...
        Qp = function(a) {
            return En("gclaw") || En("gac") || 0 < (Io().aw || []).length ? !1 : 0 < (Io().gb || []).length ?
                !0 : Wo(a)
        };
    var Sp = function(a, b) {
            var c = a.rj,
            ...
            for (var c = b.querySelectorAll("*"),
                ...
                if (!(0 <= pq.indexOf(e.tagName.toUpperCase())) && e.children instanceof HTMLCollection) {
                    for (var f = !1, g = 0; g < e.childElementCount && 1E4 > g; g++)
                        if (!(0 <= qq.indexOf(e.children[g].tagName.toUpperCase()))) {
                            f = !0;
                            break
    ...
    var lr = function(a) {
        ...
        yr = function(a) {
            or(a, ["conversion", "remarketing"]) && Q(6) && S(N.g.I) && (!Q(82) || S(N.g.N)) && !1 !== U(a.s, N.g.Ga) && !1 !== U(a.s, N.g.da) && !1 !== U(a.s, N.g.Gb) && !1 !== U(a.s, N.g.Ma) && Vq() && (a.h[N.g.fg] =
            ...
            if (wp(a, "ccd_add_1p_data", !1) && S(N.g.I)) {
                ...
                if (bj(b)) {
                    ...
                    null === c ? a.metadata.user_data_from_code =
                        null : (b.enable_code && kb(c) && (a.metadata.user_data_from_code = c), kb(b.selectors) && (a.metadata.user_data_from_manual = aj(b.selectors)))
                }
            }
        },
        Br = function(a) {
        ...
        Qr = function(a) {
            if (or(a, ["conversion", "user_data_lead", "user_data_web"]) &&
                S(N.g.I) && a.metadata.conversion_linker_enabled) {
        ...
        Rr = function(a) {
            if (or(a, ["conversion", "remarketing", "user_data_lead",
                    "user_data_web"
                ]) && a.metadata.conversion_linker_enabled && S(N.g.I)) {
                var b = !Q(3);
    ...
    var Rs = function(a) {
        ...
        Vs = function(a) {
            ...
            for (var b = [], c = 0; c < a.length; c++) {
                var d = a[c],
                    e = [];
                d && (e.push(Us(d.value)), e.push(Us(d.quantity)),
                    e.push(Us(d.item_id)), e.push(Us(d.start_date)), e.push(Us(d.end_date)), b.push("(" + e.join("*") + ")"))
            }
        ...
        bt = {},
        ct = (bt[N.g.ld] =
            "gcu", bt[N.g.pb] = "gclaw", bt[N.g.jc] = "auid", bt[N.g.rd] = "dscnt", bt[N.g.sd] = "fcntr", bt[N.g.ud] = "flng", bt[N.g.vd] = "mid", bt[N.g.Yf] = "bttype", bt[N.g.ab] = "label", bt[N.g.Hb] = "capi", bt[N.g.qa] = "currency_code", bt[N.g.wd] = "vdltv", bt[N.g.ji] = "_dbg", bt[N.g.Ad] = "oedeld", bt[N.g.sb] = "edid", bt[N.g.fg] = "fledge", bt[N.g.Fd] = "gac", bt[N.g.nc] = "gacgb", bt[N.g.jg] = "gacmcov", bt[N.g.Gd] = "gdpr", bt[N.g.ub] = "gdid", bt[N.g.ng] = "gsaexp", bt[N.g.og] = "frm", bt[N.g.Jd] = "gtm_up", bt[N.g.Ze] = "did", bt[N.g.Oc] = void 0, bt[N.g.xb] = "tiba", bt[N.g.Lb] =
            "rdp", bt[N.g.zb] = "ecsid", bt[N.g.Tc] = "delopc", bt[N.g.Od] = "gdpr_consent", bt[N.g.sa] = "oid", bt[N.g.zg] = "ec_lat", bt[N.g.Ag] = "ec_meta", bt[N.g.Bg] = "ec_m", bt[N.g.Cg] = "ec_sel", bt[N.g.Dg] = "ec_s", bt[N.g.ff] = "ec_mode", bt[N.g.za] = "userId", bt[N.g.Eg] = "us_privacy", bt[N.g.fa] = "value", bt[N.g.qc] = "gclgb", bt[N.g.Fg] = "mcov", bt[N.g.Ni] = "hn", bt[N.g.Oi] = "gtm_ee", bt[N.g.be] = "npa", bt[N.g.Gc] = null, bt[N.g.yb] = null, bt[N.g.Ia] = null, bt[N.g.Z] = null, bt[N.g.ra] = null, bt[N.g.Ea] = null, bt[N.g.df] = null, bt),
        et = function(a) {
            dt(a, function(b) {
                for (var c =
                        $s(a, b), d = c.onSuccess, e = c.Al, f = 0; f < e.length; f++) {
                    var g = e[f];
        ...
        dt = function(a, b) {
            ...
            d.gtm = cn();
            if (Q(45) || Jj())
                if (Q(45) || "remarketing" !== c)
                    if (d.gcs = im(), Q(49) || "remarketing" !== c && Kj()) d.gcd = mm(a.s);
    ...
    var qt = new RegExp(/^(.*\.)?(google|youtube|blogger|withgoogle)(\.com?)?(\.[a-z]{2})?\.?$/),
        ...
        wt = function(a) {
            ...
            ut() && (ui ?
                M(116) : M(117), vt && (b = [], window.console && window.console.log && window.console.log("GTM blocked. See go/13687728.")));
            var c = b && Xa(Na(b), rt),
    ...
    var Kt = {
        ...
        Pt = function(a, b, c) {
            if (Hk && "config" === a && !(1 < cp(b).O.length)) {
                ...
                g.length && (g.length && Hk && It.push(b + "*" + g.join(".")), yb("TAGGING", Kt[C.readyState] ||
                    14));
                d[b] = f
            }
        };
    ...
    function Nv(a, b) {
        if (!b) return b;
        for (var c = 0; c < a.length; c++)
            if (a[c] && tf[c] && !ri[String(tf[c][Qe.xa])]) return !0;
        return !1
    }
    var Pv = {};
            ...
            if (d.h) {
                ...
                if (f) {
                    ...
                    var r = d.h.prefix,
                        ...
                        u = kl(jl(il(hl(gl(el(dl(fl(cl(bl(al(new $k(d.messageContext.eventId, d.messageContext.priorityId), g), k), m), n), p), q), d.messageContext.eventMetadata),
                            function() {
                                if (t) {
                                    var v = t;
                                    t = void 0;
    ...
    aw.prototype.flush = function(a) {
        for (var b = this, c = [], d = !1, e = {}; this.h.length;) {
            ...
            var f = this.h[0],
                g = f.h;
            if (f.messageContext.deferrable) !g || Wv(this, g).C ? (f.messageContext.deferrable = !1, this.h.push(f)) : c.push(f), this.h.shift();
            else {
                switch (f.type) {
                    case "require":
    ...
    var cw = function(a, b) {
            if ("require" !== b.type)
                if (b.h)
                    for (var c = Wv(a, b.h).B[b.type] || [], d = 0; d < c.length; d++) c[d]();
                else
                    for (var e in a.B)
                ...
                if (!(2 > a.length) && h(c)) {
                    ...
                    if (h(r) || Da(r)) {
                        ...
                        var u = fw(t, b.isGtmEvent),
                            ...
                            w = u.Vl;
                        if (w.length)
                            for (var x = pw(q), y = 0; y < w.length; y++) {
    ...
    function ax() {
        var a;
        if (Sw.length) a = Sw.shift();
        else if (Rw.length) a = Rw.shift();
        else return;
        var b;
        var c = a;
        if (Tw || !$w(c.message)) b = c;
        else {
            Tw = !0;
    ...
    function gA(a, b) {
        ...
        for (var k = fA(), m = [], n = 1; n < arguments.length; n++) m.push(pd(arguments[n], this.h, k));
    ...
    function lA(a, b) {
        var c;
        K(J(this), ["key:!string", "dataLayerVersion:?number"], arguments), L(this, "read_data_layer", a), c = 2 !== (b || 2) ? Ui(a, 1) : Wi(a, [z, C]);
        ...
        MB = function(a, b, c, d) {
            function e() {
                for (var r = 0; r < g.length; r++) {
                    var t = g[r];
                    t.isAborted || (KB(g[r], !0), t.metadata.speculative ||
                        t.isAborted || et(t))
                }
            }
    ...
    var RE = window,
        ...
        TE = function(a) {
            ...
            for (var d = tm("AMP_TOKEN", String(SE.cookie), !0), e = 0; e < d.length; e++)
        ...
        function() {
            ...
            (function(f) {
                ...
                if (h(g) && 0 === g.indexOf("G-")) {
                    ...
                    var t = vG(f.vtp_eventParameters,
                            "name", "value"),
                        u;
        ...
        function() {
            function a(b, c, d) {
                ...
                var c = !b.hasOwnProperty("vtp_enableConversionLinker") || !!b.vtp_enableConversionLinker,
                    ...
                    e = vG(b.vtp_customVariables, "varName", "value") || {},
                    f = {},
                    g = (f[N.g.fa] = b.vtp_conversionValue ||
                        0, f[N.g.qa] = b.vtp_currencyCode, f[N.g.sa] = b.vtp_orderId, f[N.g.Ka] = b.vtp_conversionCookiePrefix, f[N.g.Ca] = c, f[N.g.pd] = d, f[N.g.oa] = uy(N.g.oa), f[N.g.aa] = uy("developer_id"), f);
                g[N.g.Ga] = uy(N.g.Ga), g[N.g.da] = uy(N.g.da), g[N.g.Gb] = uy(N.g.Gb), g[N.g.Ma] = uy(N.g.Ma);
                ...
                b.vtp_enableShippingData && (g[N.g.Tc] = b.vtp_deliveryPostalCode, g[N.g.Ad] = b.vtp_estimatedDeliveryDate, g[N.g.mc] = b.vtp_deliveryCountry, g[N.g.Lc] = b.vtp_shippingFee);
                ...
                if (Q(59)) {
                    ...
                    Su(Pu(ik(v), N.g.ma, g), b.vtp_gtmEventId, x)
                } else {
                    var y = kl(jl(il(hl(al(new $k(b.vtp_gtmEventId, b.vtp_gtmPriorityId), g), b.vtp_gtmOnSuccess), b.vtp_gtmOnFailure), !0));
                    y.eventMetadata.hit_type_override = "conversion";
                    MB(v, N.g.ma, Date.now(), y)
                }
            })
        }();
    Z.m.logging = ["google"],
    ...
    (function(a) {
        ...
        if (Ai) a();
            ...
            var f = function(u) {
                    ...
                    x || (x = [],
                        z["google.tagmanager.debugui2.queue"] = x, Jc("https://" + ni.Oe + "/debug/bootstrap?id=" + Uf.ctid + "&src=" + w + "&cond=" + u + "&gtm=" + cn()));
                    var y = {
        ...
        try {
            ...
            if (dk().canonical[b]) {
                ...
                a: {
                    var A = data.runtime || [],
                        B = data.runtime_lines;fz = new Ke;qG(); of = ez();
                    var D = fz,
                        G = pG(),
                        E = new ed("require", G);E.Bb();D.h.h.set("require", E);
                ...
                rG(x);
                if (void 0 !== y)
                    for (var T = 0; T < y.length; T++) Hi[y[T]] = !0;
                RH();
                if (Q(45)) {
